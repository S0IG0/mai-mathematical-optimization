...
import { fetchContour, fetchSurface, fetchVariants } from './api';
...
const LAB_TITLE =
  'Теория оптимального планирования и управления (безусловная оптимизация). Задание 3: Градиентные методы';
