...
@RestController
@RequestMapping("/api")
public class GradientOptimizationController {

    private final GradientOptimizationService service;

    public GradientOptimizationController(GradientOptimizationService service) {
    ...
    public Map<String, Object> health() {
        ...
        body.put("status", "ok");
        body.put("lab", "Задание 3: Градиентные методы");
        return body;
    }
