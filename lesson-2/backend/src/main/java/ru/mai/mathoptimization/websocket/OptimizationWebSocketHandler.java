...
public class OptimizationWebSocketHandler extends TextWebSocketHandler {
    ...
    private final MultidimOptimizationService optimizationService;
    private final ObjectMapper objectMapper;

    public OptimizationWebSocketHandler(MultidimOptimizationService optimizationService,
    ...
    private void runOptimization(WebSocketSession session, String payload) {
        try {
            ...
            send(session, "STARTED", Map.of("method", VariantRegistry.getVariant(request.getVariantId()).getMethodLabel()));
